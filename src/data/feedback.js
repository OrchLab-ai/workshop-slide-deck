module.exports = [
  {
    ...
    render(pres, ctx) {
      ...
      s.addNotes("Before we wrap up, I have one ask. You were our very first audience for this workshop, and that makes your perspective incredibly valuable. We need your honest, frank and fearless feedback to make this better for the next group. [gesture to screen] You can scan that QR code right now — it takes about 60 seconds. Tell us what worked, what didn't, what you'd want more or less of. The slides are attached to the calendar invite, so you'll have everything we covered today. And if you want to stay connected — Lee and I are both on LinkedIn, we'd love to connect. We've also set up a Discord community called Agentic Builders AU — it's brand new, so don't be surprised if it's a little quiet at first, but that's where we'll be sharing resources and continuing the conversation. If you feel strongly about some of the feedback, feel free to follow OrchLab on LinkedIn and post and tag us — I'll owe you a favour. [pause] Now, some parting thoughts...");
    }
  },
];
