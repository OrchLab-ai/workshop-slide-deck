...
module.exports = [
  {
    ...
    lensNote: "Focus areas: field names & types \u00B7 optional vs. required \u00B7 error shapes \u00B7 versioning",
    hints: {
      round1: [
        ...
        "What happens if the API returns a 4xx error or malformed JSON \u2014 does the client handle each case differently?",
        "If the vendor adds a new field next month, will the client break, silently ignore it, or log a warning?",
      ],
      round2: [
